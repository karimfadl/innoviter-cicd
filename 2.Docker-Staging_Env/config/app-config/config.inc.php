...
$this->dbCharset = 'utf8';
$this->dbHost = 'db_oxid6'; // database host name
...
$this->sShopURL     = 'http://appurl'; // eShop base url, required
$this->sSSLShopURL  = 'http://appurl';            // eShop SSL url, optional
$this->sAdminSSLURL = 'http://appurl/admin';            // eShop Admin SSL url, optional
