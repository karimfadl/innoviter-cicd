...
$this->sShopURL     = 'http://{{ site_url }}'; // eShop base url, required
$this->sSSLShopURL  = 'http://{{ site_url }}';            // eShop SSL url, optional
$this->sAdminSSLURL = 'http://{{ site_url }}/admin';            // eShop Admin SSL url, optional
