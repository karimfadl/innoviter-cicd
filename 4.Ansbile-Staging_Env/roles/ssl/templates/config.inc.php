...
$this->dbPwd  = '{{ db_password }}'; // database user password
$this->sShopURL     = 'https://{{ site_url }}'; // eShop base url, required
$this->sSSLShopURL  = 'https://{{ site_url }}';            // eShop SSL url, optional
$this->sAdminSSLURL = 'https://{{ site_url }}/admin';            // eShop Admin SSL url, optional
$this->sShopDir     = '{{ rootdir_apache }}';
$this->sCompileDir  = '{{ rootdir_apache }}/tmp';
